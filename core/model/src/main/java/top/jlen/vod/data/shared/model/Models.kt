...
data class VodItem(
    ...
    @SerializedName(value = "vod_sub", alternate = ["sub_title"]) val vodSub: String? = null,
    @SerializedName(value = "subtitle", alternate = ["subTitle"]) val compatSubtitle: String? = null,
